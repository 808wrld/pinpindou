...
The repo is currently at `/Users/noah/projects/perler-bead-generator/` (only `docs/` + `.gitignore` exist). **Task 1 renames it to `/Users/noah/projects/pinpindou/`**. All subsequent paths in this plan assume the new name.
...
**Files:**
- Modify (rename dir): `/Users/noah/projects/perler-bead-generator` → `/Users/noah/projects/pinpindou`
...
```bash
mv /Users/noah/projects/perler-bead-generator /Users/noah/projects/pinpindou
cd /Users/noah/projects/pinpindou
```
...
Tell the user:
> "Plan complete. Repo is at `/Users/noah/projects/pinpindou` on the default branch with all commits local. To push to GitHub:
> ```bash
